...
public class LiveContentManager : ILiveContentService
{
    ...
    public async Task<CreatedCourseLiveContentResponse> AssignLiveContentAsync(CreateCourseLiveContentRequest createCourseLiveContentRequest)
    {
    ...
    public async Task<Paginate<GetListLiveContentResponse>> GetListLiveContentByCourseIdAsync(Guid courseId)
    {
